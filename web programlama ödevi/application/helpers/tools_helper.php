...
function flash($type,$icon,$title,$message=null)
{
      $ci=get_instance();
           $message='<div class="alert alert-'.$type.' alert-dismissible">
               ...
               <h4><i class="icon fa fa-'.$icon.'"></i> '.$title.'</h4>'.$message.'
           </div>';
...
function deletebutton($table,$id)
{
  ...
  {
  echo '<a href="'.base_url('admin/sil/'.$table.'/'.$id).'" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-remove"></i> Sil</a>';
  }
}
...
function deletebutton2($table,$id)
{
  ...
  {
  echo '<a href="'.base_url('uyeislemleri/sil/'.$table.'/'.$id).'" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-remove"></i> Sil</a>';
  }
}
